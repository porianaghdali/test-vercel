...
export default function register() {
    ...
    const [selectedBroker, setSelectedBroker] = useState<{ name: string; farsiName: string;code:string;link:string } | null>(null);
    ...
    const stepDescription = [
        ...
        'رای تکمیل فرآیند ثبت نام، لازم است در یکی از بروکرهای مورد تایید حسنیکال ثبت‌ نام کنید. ابتدا از لیست بروکرهای معتبر، گزینه مورد نظر خود را انتخاب کنید.',
        ...
        'درخواست و اطلاعات شما برای استفاده از خدمات کش‌بک حسنیکال ثبت شد.'
    ]
    useEffect(() => {
        if (step === 4) {
        ...
        <>
            <div className="bg-[#07021C] px-4 lg:px-[72px] lg:min-h-screen  pb-8 lg:pb-16">
                ...
                <div className="flex flex-col lg:flex-row items-start justify-between">
                    ...
                    <Image className="lg:ml-14 mb-4 lg:-mb-[50px] lg:-mt-[100px] z-10" src={'/images/landings/cashBack/main.png'} width={400} height={275} alt="hesnical" />
                </div>
                ...
                <div className="p-[1px] rounded-[24px] bg-gradient-to-b from-[#1B1532] to-[#52409800]  mx-auto overflow-hidden mb-8 lg:mb-16">
                    <div className="bg-gradient-to-b from-[#1B1532] to-[#0603171A] lg:px-11 px-5 lg:py-14 py-6 backdrop-blur-[37.07px] rounded-[24px]">
                        <StepIndicator finish={isFinished} steps={["تکمیل اطلاعات شخصی", "انتخاب بروکر", "ثبت نام در بروکر", "تکمیل ثبت نام"]} currentStep={step} onStepChange={(step) => setStep(step)}/>
                                ...
                                switch (step) {
                                    ...
                                    case 3:
                                        return hasBrokerAccount ?
                                         (<Step3HasAccount setStep={setStep} selectedBroker={selectedBroker?.code}/>)
                                         :(<Step3HasNotAccount setStep={setStep} selectedBroker={selectedBroker?.link}/>);
                                        case 4:
